...
function Register() {
  ...
  const { isSignupIn, signUp } = useAuthStore();
      ...
      <div className="flex-grow flex items-center justify-center w-full">
        <div className="w-full max-w-5xl bg-base-100 rounded-lg flex items-center justify-center px-4 py-10">
          <section className="w-full">
            <form autoComplete="off" onSubmit={handleSubmit} className="w-full flex flex-col lg:flex-row items-center justify-center  gap-10 lg:gap-32 *:select-none  ">
              <div className="flex flex-col gap-6 w-full max-w-sm">
                <div className="flex flex-row gap-6">
                  <label className="input validator flex items-center gap-2  focus-within:border-green-400 focus-within:ring-1 focus-within:ring-green-300 ">
                    <input
                      type="text"
                      name="first_name"
                      placeholder="John"
                ...
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    style={{ padding: "8px" }} disabled={isSignupIn}
                  >
                    {isSignupIn ? "Processing..." : "Sign Up"}
                  </button>
                </div>

                <div className="text-md  select-none">
                  Already have an account?{" "}
                  <Link to="/login" className="text-blue-200 cursor-pointer hover:underline hover:underline">
                    Sign In
                  </Link>
                </div>
              </div>
